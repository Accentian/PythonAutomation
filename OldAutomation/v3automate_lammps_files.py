...
for data_file in all_the_dump_files:
    ...
    for csv_file in glob.glob('CNT_*.csv'):
        ...
        distance_xu = math.sqrt((max_xu - min_xu) ** 2)      ## Use for Diameter
    ...
    if mod_flag:
        ...
        log_command = f'log /ascldap/users/bcma/2ndCNTRun/{file_stem}/{file_stem}.log.lammps\n'     ## Modify
        read_command = f'read_data 	{file_stem}.dat\n'
        dump_command = f'dump           1 all atom 5000 /ascldap/users/bcma/2ndCNTRun/{file_stem}/{file_stem}.lammpstrj\n'      ## Modify
