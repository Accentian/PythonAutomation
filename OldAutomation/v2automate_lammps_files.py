...
This program goes through the directory that it is listed on and selects files with with .dump extensions,
then create a copy of .dump files and modifies if to .dat files while
creating bash and input script for those respective .dat files.
Note that this code is fragile as any changes to any of the LAMMPS files can
cause incorrect modifications.The origin of this fragility can be found in the likes of
the for loops through certain lines as seen in LINE 26.
